  ...
  staff: [
    {
      ...
      bookingLink:     'https://sqy.re/silas',
      bio:             'Specializing in precision fades and architectural hair design with 15 years of industry experience.',
      instagram:       'silas_cuts',
      contactEmail:    '',
      contactPhone:    '',
    ...
    },
    {
      ...
      photoName:       null,
      bookingStyle:    'digital',
      bookingLink:     'https://vagaro.com/elena',
      bio:             'Expert in balayage and corrective color theory. Crafting bespoke tones for the modern individual.',
      instagram:       'elena_colors',
      contactEmail:    '',
      contactPhone:    '',
      portfolioAccess: true,
    },
    {
      id: 303,
      name:            'Marcus "Pops" Miller',
      title:           'Senior Barber',
      photo:           null,
      photoName:       null,
      bookingStyle:    'walkin',
      bookingLink:     '',
      bio:             'Old school techniques for the modern man. 30 years at the chair.',
      instagram:       '',
      contactEmail:    '',
      contactPhone:    '',
    ...
    },
    {
      ...
      bookingStyle:    'build',
      bookingLink:     '',
      bio:             'Fading specialist and beard grooming expert.',
      instagram:       '',
      contactEmail:    '',
      contactPhone:    '',
      portfolioAccess: false,
    },
    {
      ...
      bookingStyle:    'hybrid',
      bookingLink:     '',
      bio:             'Specializing in high-performance skincare and traditional straight-shave facials.',
      instagram:       '',
      contactEmail:    '',
      contactPhone:    '',
      portfolioAccess: false,
